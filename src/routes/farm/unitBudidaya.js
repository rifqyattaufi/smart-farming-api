...
router.get("/search/:nama/:tipe", UnitBudidayaController.getUnitBudidayaByName);
...
router.post(
  ...
  UnitBudidayaController.createUnitBudidaya
);

router.put(
  "/:id",
  auditMiddleware({ model: UnitBudidaya, tableName: "UnitBudidaya" }),
  UnitBudidayaController.updateUnitBudidaya
);

router.delete(
  "/:id",
  auditMiddleware({ model: UnitBudidaya, tableName: "UnitBudidaya" }),
  UnitBudidayaController.deleteUnitBudidaya
);
